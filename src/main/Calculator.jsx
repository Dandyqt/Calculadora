...
export default class Calculator extends Component {
    ...
    render(){
        ...
        let addDigito = function n(){
             
        }
        
        let setOperation = function op(){
        ...
        return(
            ...
            <Display value={this.state.displayValue}/>
                <Button className='triple' label="AC" click ={this.clearMemory } />
                <Button label="/" click ={this.setOperation} className = 'operation'/>
                ...
                <Button label="+" click ={this.setOperation} className = 'operation'/>
                <Button label="0" double click={this.addDigito}className = 'double' />
